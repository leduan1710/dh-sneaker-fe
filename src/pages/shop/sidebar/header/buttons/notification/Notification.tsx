...
function HeaderNotifications() {
    ...
    const getDataNotification = async () => {
        const notificationsRes = await GetApi(`/user/get-notification-shop`, localStorage.getItem('token'));
    ...
    const handleNotificationClick = (notification: any) => {
        ...
        if (notification.link === '/shop/orders/processing') {
            navigate('/shop/management/orders', { state: { status: 'PROCESSING' } });
        }
        // Khi nhấp vào thông báo, điều hướng và truyền trạng thái
        if (notification.link === '/shop/reportProduct') {
            navigate('/shop/management/report-product', { state: {  } });
        }
    };
